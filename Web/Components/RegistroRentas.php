...
// Consultar rentas que tienen clientes y cuya fecha de devolución es igual o mayor a hoy
$sql = "SELECT r.RentaID, r.FechaRenta, r.FechaDevolucion, r.Total, r.Descuento, r.Multa
        FROM Renta r
...
<head>
    <meta charset="UTF-8">
    <title>Rentas Completadas</title>
    ...
    <script>
        ...
        function filtrarRentas() {
            ...
            for (let i = 0; i < filas.length; i++) {
                // Omitimos las filas de detalle (productos), solo filtramos filas principales
                ...
                if (textoFila.indexOf(filtro) > -1) {
                    ...
                    // Mostrar también la fila de detalle correspondiente si está visible
...
<div class="container">
    <div class="factura-card">
        <div class="factura-header">
            <h2 class="factura-title">Rentas Completadas</h2>
        </div>
            ...
            <table class="tabla-productos">
                ...
                <?php foreach ($rentas as $r): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($r['FechaRenta']) ?></td>
                        <td><?= htmlspecialchars($r['FechaDevolucion']) ?></td>
                        <td><?= htmlspecialchars($r['Multa']) ?></td>
        ...
        <?php else: ?>
            <div class="text-muted">Ninguna renta completada en este momento.</div>
        <?php endif; ?>
    </div>
</div>
</body>
